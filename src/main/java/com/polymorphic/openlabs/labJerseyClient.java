 ...
 * USAGE:
 * <pre>
 *        labJerseyClient client = new labJerseyClient();
 ...
 * @author wrights
 */
public class labJerseyClient {
  private javax.ws.rs.client.WebTarget webTarget;
  private javax.ws.rs.client.Client client;
  private static final String BASE_URI = "http://localhost:8084/openLabs/webresources";

  public labJerseyClient() {
    client = javax.ws.rs.client.ClientBuilder.newClient();
    webTarget = client.target(BASE_URI).path("com.polymorphic.openlabs.lab");
  }
